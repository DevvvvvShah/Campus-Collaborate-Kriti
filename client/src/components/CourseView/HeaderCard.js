...
const HeaderCard = (props) => {
    ...
    return (
        <div className="mt-[16vh] flex flex-col w-[80vw] bg-white">
            ...
            style={{boxShadow: '0px 0px 15px 0px #CCCCCC'}}>
                ...
                <div className='pt-[11vh] pb-[17vh]'>
                    <div className='flex gap-2'>
                        <div className='z-20'>
                            {props.project.courseLink && <a href={props.project.courseLink.startsWith('http') ? props.project.githubLink : `https://${props.project.courseLink}`} target="_blank" rel="noopener noreferrer" className="text-[#0016DA]">Course Link</a>}
                        </div>
                    </div>
            ...
            <div className='relative ml-auto bg-[#FFFFFF] w-[15vw] h-[2.5rem] flex gap-8 px-[5vw] overflow-hidden rounded-b-xl'
            style={{boxShadow: '0px 0px 15px 0px #CCCCCC'}}>            
                <div className={`flex justify-center w-full items-center gap-4 ${props.enrolled ? 'text-[#0016DA]' : 'text-black'}`}>
                    <img src="images/profile.svg" 
                        className={`w-[2rem] h-[2rem] `} 
                    />
                    <div className='text-[1.3rem]'>
                        {props.project && props.project.enrolledStudents && props.project.enrolledStudents.length || 0}
                    </div>                       
                </div>          
            </div>
        </div>
