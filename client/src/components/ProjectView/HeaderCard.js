...
const HeaderCard = (props) => {
    ...
    const handleLike = () => {
        putLike(props.project._id).then((response) => {
    ...
    const handleDislike = () => {
        ...
        putDislike(props.project._id).then((response) => {
                ...
                <div className='pt-[9vh] pb-[15vh]'>
                    <div className = "w-full flex justify-end">
                        <div className='flex text-[0.875rem] gap-1 items-center'>
                            <img src="./images/starFilled.svg" alt="Description" className="object-cover object-center w-[1.375rem] h-[1.375rem]" />
                    ...
                    <div className='flex gap-2'>
                        ...
                        .
                        <div className='z-20'>
                            {props.project.githubLink && <a href={props.project.githubLink.startsWith('http') ? props.project.githubLink : `https://${props.project.githubLink}`} target="_blank" rel="noopener noreferrer" className="text-[#0016DA]">GitHub</a>}
                        </div>
                    </div>
