...
const EditProfileCard =  () => {
    ...
    return(
        <div className='w-screen min-h-fit min-w-fit bg-[#000000] flex justify-center items-center px-4'>
            <div className='sm:min-w-[550px] sm:my-10 h-fit bg-[#FFFFFF] rounded-lg p-4 my-5'>
